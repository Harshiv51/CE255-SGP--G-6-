...
class Student:
    ...
    # This part is image labels setting start 
        ...
        main_frame.place(x=5,y=55,width=1540,height=510)
        ...
        right_frame.place(x=680,y=10,width=900,height=480)
        ...
        search_frame.place(x=10,y=5,width=750,height=80)
        ...
        table_frame.place(x=10,y=90,width=750,height=360)
        ...
        #create table 
        self.student_table = ttk.Treeview(table_frame,column=("Dep","Course","Year","Sem","ID","Name","Div","Roll-No","Gender","DOB","Mob-No","Address","Email","Teacher","Photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
...
# ==================Function Decleration==============================
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                conn = mysql.connector.connect(username='root', password='harshiv22',host='localhost',database='project',port=3306)
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT Student_id,Name,Dep,course,Year,Semester,Division,Gender,Dob,Phone,Address,Roll,Email,Teacher,PhotoSample FROM student where Roll='" +str(self.var_search.get()) + "'" 
